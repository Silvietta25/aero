...
%% Plot del Cp (con NACA 0012 e alpha=5)
figure
CpXFoil = importfile1('CpNaca0012Alfa5');
plot(centre_vect((1:(N_pann+1)/2),1),-Cp((1:(N_pann+1)/2),1),'r','LineWidth',5)
hold on
plot(centre_vect((N_pann+1)/2:end,1),-Cp((N_pann+1)/2:end,1),'b','LineWidth',5)
hold on
